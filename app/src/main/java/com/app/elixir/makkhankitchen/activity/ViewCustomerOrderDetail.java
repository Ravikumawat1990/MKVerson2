...
public class ViewCustomerOrderDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CM.startActivity(ViewCustomerOrderDetail.this, ViewDrawerActivty.class);
                finish();
            }
        });
        ...
        if (CM.isInternetAvailable(ViewCustomerOrderDetail.this)) {
            if (CM.getSp(ViewCustomerOrderDetail.this, "logout", "").toString() != null && CM.getSp(ViewCustomerOrderDetail.this, "logout", "").toString().equals("1")) {
                Intent intent = new Intent(ViewCustomerOrderDetail.this, ViewSplash.class);
                ...
                if (getIntent().getExtras() != null) {
                    ...
                    CM.showPopupCommonValidation(ViewCustomerOrderDetail.this, "No Data Found", true);
                }
            }
        } else {
            CM.showToast(ViewCustomerOrderDetail.this, getString(R.string.internetMsg));
        }
    ...
    public void initView() {
        ...
        mLayoutManager = new LinearLayoutManager(ViewCustomerOrderDetail.this);
    ...
    public void webCallOrderDtail(String cusId) {
        try {
            VolleyIntialization v = new VolleyIntialization(ViewCustomerOrderDetail.this, true, true);
            WebService.getResponseForOrderDetail(v, cusId, new OnVolleyHandler() {
                ...
                public void onVollyError(String error) {
                    ...
                    if (CM.isInternetAvailable(ViewCustomerOrderDetail.this)) {
                        CM.showPopupCommonValidation(ViewCustomerOrderDetail.this, error, false);
                    }
                }
            });
    ...
    private void getResponseForOrderHistory(String response) {
        ...
        if (strResponseStatus.equalsIgnoreCase(WebServiceTag.WEB_STATUSFAIL)) {
            CM.showPopupCommonValidation(ViewCustomerOrderDetail.this, CM.getValueFromJson(WebServiceTag.WEB_STATUS_ERRORTEXT, response), false);
            return;
        }
        try {
            ...
            if (jsonObject.getString("ResponseCode").equals("202")) {
                ...
                txtcustAmount.setText(CM.getSp(ViewCustomerOrderDetail.this, "currency", "").toString() + " " + orderDeliveryArray.get(0).nAmount);


                adptCustomerorderDetail adptCustomerorderDetail = new adptCustomerorderDetail(ViewCustomerOrderDetail.this, orderDeliveryArray.get(0).orderDeliveryDetailArraySubs.get(0).orderDeliveryDetailArraySubSubs);
            ...
            CM.showPopupCommonValidation(ViewCustomerOrderDetail.this, e.getMessage(), false);
        }
    }
