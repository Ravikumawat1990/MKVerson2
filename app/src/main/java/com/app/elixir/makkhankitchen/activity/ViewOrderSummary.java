...
import com.app.elixir.makkhankitchen.Model.OrderSummeryModel;
import com.app.elixir.makkhankitchen.Model.OrderSummeryModelArray;
import com.app.elixir.makkhankitchen.Model.OrderSummeryModelArraysSub;
import com.app.elixir.makkhankitchen.Model.TimeModel;
import com.app.elixir.makkhankitchen.adapter.CustomSpinnerAdapter;
import com.app.elixir.makkhankitchen.adapter.ListViewAdapter;
import com.app.elixir.makkhankitchen.adapter.adptordersummery;
...
import com.app.elixir.makkhankitchen.pojo.OrderSummeryPojo;
import com.app.elixir.makkhankitchen.pojo.OrderSummeryPojoArray;
import com.app.elixir.makkhankitchen.pojo.OrderSummeryPojoArraySub;
import com.app.elixir.makkhankitchen.pojo.OrderSummeryPojoArraySubSub;
...
//                                            CM.startActivity(ViewOrderSummary.this, ViewCustomerDetail.class);
        ...
        try {
            ...
            if (jsonObject.getString("ResponseCode") != null && jsonObject.getString("ResponseCode").equals("202")) {
                ...
                mAdapter.SetOnItemClickListener(new OnItemClickListenerOrderSuumnery() {
                    @Override
                    public void onItemClick(String cartId, String cartIdDetail, String status, String comProId) {
                        if (status.equals("edit")) {
                            if (CM.isInternetAvailable(ViewOrderSummary.this)) {


                                Intent intent = new Intent(ViewOrderSummary.this, ViewFoodItemDetail.class);
                                intent.putExtra("isedit", "isedit");
                                intent.putExtra("catId", cartId);
                                intent.putExtra("comProId", comProId);
                            ...
                            if (CM.isInternetAvailable(ViewOrderSummary.this)) {
                                ...
                                showPopup(ViewOrderSummary.this, cartId, cartIdDetail, comProId);
                            } else {
                                CM.showToast(ViewOrderSummary.this, getString(R.string.internetMsg));
                            }
                        }
    ...
    public void webCallRemoveCart(String cartId, String cartDetailId, String comProId) {
        try {
            VolleyIntialization v = new VolleyIntialization(ViewOrderSummary.this, true, true);

            WebService.getResponseForRemoveCART(v, cartId, cartDetailId, comProId, new OnVolleyHandler() {
                @Override
                public void onVollySuccess(String response) {
                    if (isFinishing()) {
                        return;
...
//                            }
    ...
    public void showPopup(Context context, final String cartId, final String cartDeID, final String comProdId) {
        ...
        new AlertDialog.Builder(context)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        webCallRemoveCart(cartId, cartDeID, comProdId);
                    }
