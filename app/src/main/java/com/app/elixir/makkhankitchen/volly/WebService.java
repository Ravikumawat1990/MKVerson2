...
//
    ...
    public static void getResendForCategories(VolleyIntialization volleyIntialization, String index, OnVolleyHandler vollyHanlder) throws JSONException {
        ...
        params.add(new BasicNameValuePair(CONSTANT.CAPIPASS, CONSTANT.cAPIPass));
        params.add(new BasicNameValuePair(CONSTANT.NCOMPANYID, CONSTANT.nCompanyID));
        params.add(new BasicNameValuePair(CONSTANT.INDEX, index));
        volleyIntialization.vollyStringRequestCall(url, Request.Method.GET, params, vollyHanlder, false);
    }

    public static void getResendForCategoryItem(VolleyIntialization vollyInit, String id, String index, OnVolleyHandler vollyHanlder) throws JSONException {
    ...
    public static void getResendForEditCategoryItemDetail(VolleyIntialization vollyInit, String catId, String cusId, String comProductId, OnVolleyHandler vollyHanlder) throws JSONException {
        String url = URLS.GETPRODUCTSDETAILFRMCART;
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair(CONSTANT.CAPPSTORECODE, CONSTANT.cAppStoreCode));
        params.add(new BasicNameValuePair(CONSTANT.CAPIKEY, CONSTANT.cAPIKey));
        params.add(new BasicNameValuePair(CONSTANT.CAPIPASS, CONSTANT.cAPIPass));
        params.add(new BasicNameValuePair(CONSTANT.NCOMPANYID, CONSTANT.nCompanyID));
        params.add(new BasicNameValuePair(CONSTANT.NCOMPANYPRODUCTID, comProductId));
        params.add(new BasicNameValuePair(CONSTANT.NCUSTOMERID, cusId));
        params.add(new BasicNameValuePair(CONSTANT.NCARTID, catId));
        vollyInit.vollyStringRequestCall(url, Request.Method.GET, params, vollyHanlder, false);
    }

    //
    public static void getResendForCategoryItemDetail(VolleyIntialization vollyInit, String comPrId, String cusId, OnVolleyHandler vollyHanlder) throws JSONException {
        ...
        params.add(new BasicNameValuePair(CONSTANT.CAPIPASS, CONSTANT.cAPIPass));
        params.add(new BasicNameValuePair(CONSTANT.NCOMPANYID, CONSTANT.nCompanyID));
        params.add(new BasicNameValuePair(CONSTANT.NCOMPANYPRODUCTID, comPrId));
        params.add(new BasicNameValuePair(CONSTANT.NCUSTOMERID, cusId));
        vollyInit.vollyStringRequestCall(url, Request.Method.GET, params, vollyHanlder, false);
    }
...
//    cAppStoreCode=r-1&cAPIKey=a&cAPIPass=a&nCompanyID=1
    ...
    public static void getResendForRemoveFav(VolleyIntialization vollyInit, String cusId, String compProId, OnVolleyHandler vollyHanlder) throws JSONException {
        String url = URLS.REMOVETOFAVOURITE;
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair(CONSTANT.CAPPSTORECODE, CONSTANT.cAppStoreCode));
        params.add(new BasicNameValuePair(CONSTANT.CAPIKEY, CONSTANT.cAPIKey));
        params.add(new BasicNameValuePair(CONSTANT.CAPIPASS, CONSTANT.cAPIPass));
        params.add(new BasicNameValuePair(CONSTANT.NCOMPANYID, CONSTANT.nCompanyID));
        params.add(new BasicNameValuePair(CONSTANT.NCUSTOMERID, cusId));
        params.add(new BasicNameValuePair(CONSTANT.NCOMPANYPRODUCTID, compProId));
        vollyInit.vollyStringRequestCall(url, Request.Method.POST, params, vollyHanlder, false);
    }
...
//    }
    ...
    public static void getResponseForRemoveCART(VolleyIntialization vollyInit, String cartID, String cartIdDetail, String comProId, OnVolleyHandler vollyHanlder) throws JSONException {
        ...
        params.add(new BasicNameValuePair(CONSTANT.CAPIPASS, CONSTANT.cAPIPass));
        params.add(new BasicNameValuePair(CONSTANT.NCOMPANYID, CONSTANT.nCompanyID));
        params.add(new BasicNameValuePair(CONSTANT.NCOMPANYPRODUCTID, comProId));
        params.add(new BasicNameValuePair(CONSTANT.NCARTID, cartID));
    ...
    public static void getResponseAddToFav(VolleyIntialization vollyInit, String nComPid, String custId, OnVolleyHandler vollyHanlder) throws JSONException {
        String url = URLS.ADDTOFAVOURITE;
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair(CONSTANT.CAPPSTORECODE, CONSTANT.cAppStoreCode));
        params.add(new BasicNameValuePair(CONSTANT.CAPIKEY, CONSTANT.cAPIKey));
        params.add(new BasicNameValuePair(CONSTANT.CAPIPASS, CONSTANT.cAPIPass));
        params.add(new BasicNameValuePair(CONSTANT.NCOMPANYPRODUCTID, nComPid));
        params.add(new BasicNameValuePair(CONSTANT.NCUSTOMERID, custId));

        vollyInit.vollyStringRequestCall(url, Request.Method.POST, params, vollyHanlder, false);
    }

    public static void getResponseGetFav(VolleyIntialization vollyInit, String cusId, OnVolleyHandler vollyHanlder) throws JSONException {
        String url = URLS.GETFAVOURITEPRODUCTS;
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair(CONSTANT.CAPPSTORECODE, CONSTANT.cAppStoreCode));
        params.add(new BasicNameValuePair(CONSTANT.CAPIKEY, CONSTANT.cAPIKey));
        params.add(new BasicNameValuePair(CONSTANT.CAPIPASS, CONSTANT.cAPIPass));
    ...
    public static void getResponseSetDevice(VolleyIntialization vollyInit, String cusId, String deviceId, OnVolleyHandler vollyHanlder) throws JSONException {
        String url = URLS.SETDEVICE;
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair(CONSTANT.CAPPSTORECODE, CONSTANT.cAppStoreCode));
        params.add(new BasicNameValuePair(CONSTANT.CAPIKEY, CONSTANT.cAPIKey));
        params.add(new BasicNameValuePair(CONSTANT.CAPIPASS, CONSTANT.cAPIPass));
        params.add(new BasicNameValuePair(CONSTANT.NDEVICEID, deviceId));
        params.add(new BasicNameValuePair(CONSTANT.NCUSTOMERID, cusId));
        vollyInit.vollyStringRequestCall(url, Request.Method.POST, params, vollyHanlder, false);
    }

    public static void getResponseRemoveDevice(VolleyIntialization vollyInit, String cusId, String deviceId, OnVolleyHandler vollyHanlder) throws JSONException {
        String url = URLS.REMOVEDEVICE;
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair(CONSTANT.CAPPSTORECODE, CONSTANT.cAppStoreCode));
        params.add(new BasicNameValuePair(CONSTANT.CAPIKEY, CONSTANT.cAPIKey));
        params.add(new BasicNameValuePair(CONSTANT.CAPIPASS, CONSTANT.cAPIPass));
