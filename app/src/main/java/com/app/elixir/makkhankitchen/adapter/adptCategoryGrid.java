...
public class adptCategoryGrid extends RecyclerView.Adapter<adptCategoryGrid.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(View itemView) {
            ...
            linearLayout = (LinearLayout) itemView.findViewById(R.id.removeFavLayout);
        ...
        public void onClick(View view) {
            ...
            } else if (view.getId() == R.id.removeFavLayout) {
                listener.onItemClick("delete", this.getPosition());
            }
        }
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adaptercategorygrid, parent, false);
