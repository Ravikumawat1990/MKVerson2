...
import com.app.elixir.makkhankitchen.utils.messageListionerService;
                ...
                if (jsonArray.getString("cUserType").toString().equals("Customer")) {
                    ...
                    if ((model_main.nCustomerID != null)) {
                        if (model_main.nCustomerID.toString().equals("0")) {
                            ...
                            webCallSetDivice(model_main.nCustomerID, CM.getSp(ViewOTPScreen.this, "regId", "").toString(), "cust");
                    ...
                    if (model_main.nUserID != null) {
                        if (model_main.nUserID.toString().equals("0")) {
                            ...
                            webCallSetDivice(model_main.nCustomerID, CM.getSp(ViewOTPScreen.this, "regId", "").toString(), "del");
